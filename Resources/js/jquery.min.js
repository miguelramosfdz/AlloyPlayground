(function(a, b) {
    ...
    function cr(a) {
        if (!cg[a]) {
            ...
            if ("none" === e || "" === e) {
                ...
                b.appendChild(ch);
                ci && ch.createElement || (ci = (ch.contentWindow || ch.contentDocument).document, 
                ci.write(("CSS1Compat" === c.compatMode ? "<!doctype html>" : "") + "<html><body>"), 
                ci.close());
    ...
    function bY(a, b, c, d) {
        if (f.isArray(b)) f.each(b, function(b, e) {
            c || bA.test(a) ? d(a, e) : bY(a + "[" + ("object" == typeof e || f.isArray(e) ? b : "") + "]", e, c, d);
        }); else if (c || null == b || "object" != typeof b) d(a, b); else for (var e in b) bY(a + "[" + e + "]", b[e], c, d);
    }
    function bX(a, c) {
    ...
    function bW(a, c, d, e, f, g) {
        ...
        var l, h = a[f], i = 0, j = h ? h.length : 0, k = a === bP;
    ...
    function bV(a) {
        return function(b, c) {
            ...
            if (f.isFunction(c)) {
                var h, i, j, d = b.toLowerCase().split(bL), e = 0, g = d.length;
    ...
    function by(a, b, c) {
        var d = "width" === b ? a.offsetWidth : a.offsetHeight, e = "width" === b ? bt : bu;
        if (d > 0) {
            "border" !== c && f.each(e, function() {
        ...
        d = parseFloat(d) || 0, c && f.each(e, function() {
            d += parseFloat(f.css(a, "padding" + this)) || 0, "padding" !== c && (d += parseFloat(f.css(a, "border" + this + "Width")) || 0), 
    ...
    function L(a) {
        ...
        if (!(a.liveFired === this || !r || !r.live || a.target.disabled || a.button && "click" === a.type)) {
            ...
            for (i = 0; s.length > i; i++) g = s[i], g.origType.replace(w, "") === a.type ? q.push(g.selector) : s.splice(i--, 1);
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function() {
        ...
        e.fn = e.prototype = {
            ...
            uaMatch: function(a) {
                a = a.toLowerCase();
                var b = s.exec(a) || t.exec(a) || u.exec(a) || 0 > a.indexOf("compatible") && v.exec(a) || [];
                return {
                    browser: b[1] || "",
                    version: b[2] || "0"
                };
    ...
    f.extend({
        _Deferred: function() {
            var b, c, d, a = [], e = {
                    ...
                    if (!d) {
                        ...
                        b && (k = b, b = 0);
                        for (g = 0, h = c.length; h > g; g++) i = c[g], j = f.type(i), "array" === j ? e.done.apply(e, i) : "function" === j && a.push(i);
        ...
        i.setAttribute("type", "radio"), k.radioValue = "t" === i.value, i.setAttribute("checked", "checked"), 
        a.appendChild(i), l = c.createDocumentFragment(), l.appendChild(a.firstChild), k.checkClone = l.cloneNode(!0).cloneNode(!0).lastChild.checked, 
        ...
        k.boxModel = 2 === a.offsetWidth, "zoom" in a.style && (a.style.display = "inline", 
        a.style.zoom = 1, k.inlineBlockNeedsLayout = 2 === a.offsetWidth, a.style.display = "", 
        a.innerHTML = "<div style='width:4px;'></div>", k.shrinkWrapBlocks = 2 !== a.offsetWidth), 
        a.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>", 
        q = a.getElementsByTagName("td"), u = 0 === q[0].offsetHeight, q[0].style.display = "", 
        q[1].style.display = "none", k.reliableHiddenOffsets = u && 0 === q[0].offsetHeight, 
        a.innerHTML = "", c.defaultView && c.defaultView.getComputedStyle && (j = c.createElement("div"), 
        j.style.width = "0", j.style.marginRight = "0", a.appendChild(j), k.reliableMarginRight = 0 === (parseInt((c.defaultView.getComputedStyle(j, null) || {
            marginRight: 0
        }).marginRight, 10) || 0)), o.innerHTML = "", n.removeChild(o);
        if (a.attachEvent) for (t in {
            submit: 1,
            change: 1,
            focusin: 1
        }) s = "on" + t, u = s in a, u || (a.setAttribute(s, "return;"), u = "function" == typeof a[s]), 
        k[t + "Bubbles"] = u;
    ...
    f.extend({
        ...
        data: function(a, c, d, e) {
            if (!!f.acceptData(a)) {
                ...
                if ("events" === c && !g[c]) return g[i] && g[i].events;
                j ? (h = g[c], null == h && (h = g[f.camelCase(c)])) : h = g;
                return h;
            }
        },
            ...
            if ("undefined" == typeof a) {
                if (this.length) {
                    ...
                    if (1 === this[0].nodeType) {
                        var g, e = this[0].attributes;
                        for (var h = 0, i = e.length; i > h; h++) g = e[h].name, 0 === g.indexOf("data-") && (g = f.camelCase(g.substring(5)), 
                        k(this[0], g, d[g]));
                    }
                }
                return d;
        ...
        promise: function(a, c) {
            ...
            while (g--) (l = f.data(e[g], i, b, !0) || (f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f._Deferred(), !0)) && (h++, 
            l.done(m));
            m();
            return d.promise();
        }
    ...
    f.fn.extend({
        ...
        hasClass: function(a) {
            var b = " " + a + " ";
            for (var c = 0, d = this.length; d > c; c++) if (1 === this[c].nodeType && (" " + this[c].className + " ").replace(n, " ").indexOf(b) > -1) return !0;
            return !1;
        },
        val: function(a) {
            var c, d, e = this[0];
            if (!arguments.length) {
                if (e) {
                    ...
                    d = e.value;
                    return "string" == typeof d ? d.replace(p, "") : null == d ? "" : d;
                }
                return b;
            }
            ...
            return this.each(function(d) {
                var h, e = f(this);
                if (1 === this.nodeType) {
                    h = g ? a.call(this, d, e.val()) : a, null == h ? h = "" : "number" == typeof h ? h += "" : f.isArray(h) && (h = f.map(h, function(a) {
                        return null == a ? "" : a + "";
        ...
        attr: function(a, c, d, e) {
            ...
            if (i && "get" in i && j && null !== (h = i.get(a, c))) return h;
            h = a.getAttribute(c);
            return null === h ? b : h;
        },
        removeAttr: function(a, b) {
            var c;
            1 === a.nodeType && (b = f.attrFix[b] || b, f.attr(a, b, ""), a.removeAttribute(b), 
        ...
        prop: function(a, c, d) {
            ...
            return d !== b ? h && "set" in h && (g = h.set(a, d, c)) !== b ? g : a[c] = d : h && "get" in h && null !== (g = h.get(a, c)) ? g : a[c];
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
    ...
    f.event = {
        add: function(a, c, d, e) {
            if (3 !== a.nodeType && 8 !== a.nodeType) {
                ...
                while (l = c[m++]) {
                    ...
                    p.add && (p.add.call(a, h), h.handler.guid || (h.handler.guid = d.guid)), o.push(h), 
                    f.event.global[l] = !0;
                }
                a = null;
            }
        ...
        remove: function(a, c, d, e) {
            if (3 !== a.nodeType && 8 !== a.nodeType) {
                ...
                if (!c || "string" == typeof c && "." === c.charAt(0)) {
                    c = c || "";
                ...
                c = c.split(" ");
                while (h = c[k++]) {
                    r = h, q = null, l = 0 > h.indexOf("."), m = [], l || (m = h.split("."), h = m.shift(), 
                    ...
                    o = f.event.special[h] || {};
                    for (j = e || 0; p.length > j; j++) {
                        q = p[j];
                        if (d.guid === q.guid) {
                            (l || n.test(q.namespace)) && (null == e && p.splice(j--, 1), o.remove && o.remove.call(a, q));
                            if (null != e) break;
                        }
                    }
        ...
        trigger: function(c, d, e, g) {
            ...
            if (!!e && !f.event.customEvent[h] || !!f.event.global[h]) {
                ...
                c.type = h, c.exclusive = j, c.namespace = i.join("."), c.namespace_re = new RegExp("(^|\\.)" + i.join("\\.(?:.*\\.)?") + "(\\.|$)");
                ...
                var k = e, l = 0 > h.indexOf(":") ? "on" + h : "";
                do {
                    var m = f._data(k, "handle");
                    c.currentTarget = k, m && m.apply(k, d), l && f.acceptData(k) && k[l] && k[l].apply(k, d) === !1 && (c.result = !1, 
        ...
        fix: function(a) {
            ...
            a.target || (a.target = a.srcElement || c), 3 === a.target.nodeType && (a.target = a.target.parentNode), 
            ...
            !a.metaKey && a.ctrlKey && (a.metaKey = a.ctrlKey), !a.which && a.button !== b && (a.which = 1 & a.button ? 1 : 2 & a.button ? 3 : 4 & a.button ? 2 : 0);
            return a;
        },
        guid: 1e8,
        proxy: f.proxy,
        ...
        b && f.extend(this, b), this.timeStamp = f.now(), this[f.expando] = !0;
    }, f.Event.prototype = {
    ...
    if (!f.support.changeBubbles) {
        var G, H = function(a) {
            ...
            "radio" === b || "checkbox" === b ? c = a.checked : "select-multiple" === b ? c = a.selectedIndex > -1 ? f.map(a.options, function(a) {
                return a.selected;
            ...
            if (!!x.test(d.nodeName) && !d.readOnly) {
                e = f._data(d, "_change_data"), g = H(d), ("focusout" !== c.type || "radio" !== d.type) && f._data(d, "_change_data", g);
                if (e === b || g === e) return;
                (null != e || g) && (c.type = "change", c.liveFired = b, f.event.trigger(c, arguments[1], d));
            }
        };
    ...
    f.support.focusinBubbles || f.each({
        ...
        f.fn[c] = function(a, d, e) {
            ...
            (2 === arguments.length || d === !1) && (e = d, d = b);
            "one" === c ? (g = function(a) {
                f(this).unbind(a, g);
                return e.apply(this, arguments);
            }, g.guid = e.guid || f.guid++) : g = e;
            if ("unload" === a && "one" !== c) this.one(a, d, e); else for (var i = 0, j = this.length; j > i; i++) f.event.add(this[i], a, g, d);
            return this;
        };
    }), f.fn.extend({
        unbind: function(a, b) {
    ...
    f.each([ "live", "die" ], function(a, c) {
        f.fn[c] = function(a, d, e, g) {
            ...
            while (null != (h = a[i++])) {
                ...
                l = h, K[h] ? (a.push(K[h] + k), h += k) : h = (K[h] || h) + k;
                if ("live" === c) for (var p = 0, q = n.length; q > p; p++) f.event.add(n[p], "live." + M(h, m), {
                    data: d,
                    selector: m,
                    handler: e,
                    origType: h,
            ...
            for (var g = 0, h = d.length; h > g; g++) {
                ...
                if (i) {
                    ...
                    while (i) {
                        ...
                        1 === i.nodeType && !f && (i.sizcache = c, i.sizset = g);
        ...
        var k = function(b, d, f, g) {
            ...
            if (x.length > 1 && m.exec(b)) if (2 === x.length && l.relative[x[0]]) j = v(x[0] + x[1], d); else {
                j = l.relative[x[0]] ? [ d ] : k(x.shift(), d);
                while (x.length) b = x.shift(), l.relative[b] && (b += x.shift()), j = v(b, j);
            } else {
                !g && x.length > 1 && 9 === d.nodeType && !w && l.match.ID.test(x[0]) && !l.match.ID.test(x[x.length - 1]) && (q = k.find(x.shift(), d, w), 
                ...
                if (d) {
                    ...
                    while (x.length) r = x.pop(), s = r, l.relative[r] ? s = x.pop() : r = "", null == s && (s = d), 
                    l.relative[r](n, s, w);
                } else n = x = [];
            }
            n || (n = j), n || k.error(r || b);
            if ("[object Array]" === e.call(n)) if (u) if (d && 1 === d.nodeType) for (t = 0; null != n[t]; t++) n[t] && (n[t] === !0 || 1 === n[t].nodeType && k.contains(d, n[t])) && f.push(j[t]); else for (t = 0; null != n[t]; t++) n[t] && 1 === n[t].nodeType && f.push(j[t]); else f.push.apply(f, n); else p(n, f);
        ...
        k.uniqueSort = function(a) {
            if (r) {
                g = h, a.sort(r);
                if (g) for (var b = 1; a.length > b; b++) a[b] === a[b - 1] && a.splice(b--, 1);
            }
            return a;
            ...
            filter: {
                ...
                CHILD: function(a, b) {
                    ...
                    switch (c) {
                      case "only":
                      case "first":
                        while (d = d.previousSibling) if (1 === d.nodeType) return !1;
                        if ("first" === c) return !0;
                        d = a;

                      case "last":
                        while (d = d.nextSibling) if (1 === d.nodeType) return !1;
                        return !0;
        ...
        c.documentElement.compareDocumentPosition ? r = function(a, b) {
            ...
            var c, b = "";
            for (var d = 0; a[d]; d++) c = a[d], 3 === c.nodeType || 4 === c.nodeType ? b += c.nodeValue : 8 !== c.nodeType && (b += k.getText(c.childNodes));
            return b;
        }, function() {
        ...
        f.find = k, f.expr = k.selectors, f.expr[":"] = f.expr.filters, f.unique = k.uniqueSort, 
        f.text = k.getText, f.isXMLDoc = k.isXML, f.contains = k.contains;
    }();
    ...
    f.fn.extend({
        ...
        f.fn[a] = function(c, d) {
            ...
            N.test(a) || (d = c), d && "string" == typeof d && (e = f.filter(d, e)), e = this.length > 1 && !T[a] ? f.unique(e) : e, 
    ...
    var W = / jQuery\d+="(?:\d+|null)"/g, X = /^\s+/, Y = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Z = /<([\w:]+)/, $ = /<tbody/i, _ = /<|&#?\w+;/, ba = /<(?:script|object|embed|option|style)/i, bb = /checked\s*(?:[^=]|=\s*.checked.)/i, bc = /\/(java|ecma)script/i, bd = /^\s*<!(?:\[CDATA\[|\-\-)/, be = {
    ...
    be.th = be.td, f.support.htmlSerialize || (be._default = [ 1, "div<div>", "</div>" ]), 
    f.fn.extend({
        text: function(a) {
            if (f.isFunction(a)) return this.each(function(b) {
                var c = f(this);
        ...
        html: function(a) {
            ...
            if ("string" != typeof a || ba.test(a) || !f.support.leadingWhitespace && X.test(a) || be[(Z.exec(a) || [ "", "" ])[1].toLowerCase()]) f.isFunction(a) ? this.each(function(b) {
                var c = f(this);
        ...
        domManip: function(a, c, d) {
            ...
            if (this[0]) {
                ...
                if (g) {
                    c = c && f.nodeName(g, "tr");
                    for (var l = 0, m = this.length, n = m - 1; m > l; l++) d.call(c ? bf(this[l], g) : this[l], e.cacheable || m > 1 && n > l ? f.clone(h, !0, !0) : h);
                }
        ...
        1 === a.length && "string" == typeof a[0] && 512 > a[0].length && i === c && "<" === a[0].charAt(0) && !ba.test(a[0]) && (f.support.checkClone || !bb.test(a[0])) && (g = !0, 
        h = f.fragments[a[0]], h && 1 !== h && (e = h)), e || (e = i.createDocumentFragment(), 
        ...
        clean: function(a, b, d, e) {
            ...
            for (var k, j = 0; null != (k = a[j]); j++) {
                ...
                var r;
                if (!f.support.appendChecked) if (k[0] && "number" == typeof (r = k.length)) for (i = 0; r > i; i++) bk(k[i]); else bk(k);
    ...
    var bv, bw, bx, bm = /alpha\([^)]*\)/i, bn = /opacity=([^)]*)/, bo = /([A-Z]|^ms)/g, bp = /^-?\d+(?:px)?$/i, bq = /^-?\d/, br = /^([\-+])=([\-+.\de]+)/, bs = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, bt = [ "Left", "Right" ], bu = [ "Top", "Bottom" ];
    f.fn.css = function(a, c) {
        ...
        style: function(a, c, d, e) {
            if (!!a && 3 !== a.nodeType && 8 !== a.nodeType && !!a.style) {
                ...
                h = typeof d, "string" === h && (g = br.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), 
                h = "number");
        ...
        f.cssHooks[b] = {
            get: function(a, c, d) {
                var e;
                if (c) {
                    if (0 !== a.offsetWidth) return by(a, b, d);
        ...
        f.support.reliableMarginRight || (f.cssHooks.marginRight = {
            get: function(a, b) {
                ...
                f.swap(a, {
                    ...
                    c = b ? bv(a, "margin-right", "marginRight") : a.style.marginRight;
                });
                return c;
            }
        });
        ...
        (g = e.getComputedStyle(a, null)) && (d = g.getPropertyValue(c), "" === d && !f.contains(a.ownerDocument.documentElement, a) && (d = f.style(a, c)));
        return d;
    }), c.documentElement.currentStyle && (bx = function(a, b) {
        var c, d = a.currentStyle && a.currentStyle[b], e = a.runtimeStyle && a.runtimeStyle[b], f = a.style;
        !bp.test(d) && bq.test(d) && (c = f.left, e && (a.runtimeStyle.left = a.currentStyle.left), 
        f.left = "fontSize" === b ? "1em" : d || 0, d = f.pixelLeft + "px", f.left = c, 
    ...
    var bR, bS, bz = /%20/g, bA = /\[\]$/, bB = /\r?\n/g, bC = /#.*$/, bD = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, bE = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, bF = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, bG = /^(?:GET|HEAD)$/, bH = /^\/\//, bI = /\?/, bJ = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bK = /^(?:select|textarea)/i, bL = /\s+/, bM = /([?&])_=[^&]*/, bN = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bO = f.fn.load, bP = {}, bQ = {}, bT = [ "*/" ] + [ "*" ];
    try {
        bR = e.href;
    } catch (bU) {
    ...
    bS = bN.exec(bR.toLowerCase()) || [], f.fn.extend({
        load: function(a, c, d) {
            if ("string" != typeof a && bO) return bO.apply(this, arguments);
        ...
        ajax: function(a, c) {
            function w(a, c, l, m) {
                if (2 !== s) {
                    ...
                    var o, r, u, y, z, w = c, x = l ? bZ(d, v, l) : b;
                    ...
                    i.resolveWith(e, [ v, w ]), t && (g.trigger("ajaxComplete", [ v, d ]), --f.active || f.event.trigger("ajaxStop"));
                }
            }
            ...
            h.promise(v), v.success = v.done, v.error = v.fail, v.complete = i.done, v.statusCode = function(a) {
                ...
                return this;
            }, d.url = ((a || d.url) + "").replace(bC, "").replace(bH, bS[1] + "//"), d.dataTypes = f.trim(d.dataType || "*").toLowerCase().split(bL), 
            null == d.crossDomain && (r = bN.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bS[1] && r[2] == bS[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (bS[3] || ("http:" === bS[1] ? 80 : 443)))), 
            d.data && d.processData && "string" != typeof d.data && (d.data = f.param(d.data, d.traditional)), 
            bW(bP, d, c, v);
            if (2 === s) return !1;
            t = d.global, d.type = d.type.toUpperCase(), d.hasContent = !bG.test(d.type), t && 0 === f.active++ && f.event.trigger("ajaxStart");
            if (!d.hasContent) {
            ...
            f.etag[k] && v.setRequestHeader("If-None-Match", f.etag[k])), v.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + bT + "; q=0.01" : "") : d.accepts["*"]);
    ...
    f.ajaxSetup({
        ...
        if ("jsonp" === b.dataTypes[0] || b.jsonp !== !1 && (ca.test(b.url) || e && ca.test(b.data))) {
            var g, h = b.jsonpCallback = f.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, i = a[h], j = b.url, k = b.data, l = "$1" + h + "$2";
            b.jsonp !== !1 && (j = j.replace(ca, l), b.url === j && (e && (k = k.replace(ca, l)), 
    ...
    var cd, cb = a.ActiveXObject ? function() {
            ...
            return {
                send: function(e, g) {
                    ...
                    h.send(c.hasContent && c.data || null), d = function(a, e) {
                        ...
                        m && g(j, k, m, l);
                    }, c.async && 4 !== h.readyState ? (i = ++cc, cb && (cd || (cd = {}, f(a).unload(cb)), 
                    cd[i] = d), h.onreadystatechange = d) : d();
                },
                abort: function() {
                    d && d(0, 1);
                }
    ...
    var ch, ci, cl, cn, cg = {}, cj = /^(?:toggle|show|hide)$/, ck = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, cm = [ [ "height", "marginTop", "marginBottom", "paddingTop", "paddingBottom" ], [ "width", "marginLeft", "marginRight", "paddingLeft", "paddingRight" ], [ "opacity" ] ];
    f.fn.extend({
        show: function(a, b, c) {
            var d, e;
            if (a || 0 === a) return this.animate(cq("show", 3), a, b, c);
            for (var g = 0, h = this.length; h > g; g++) d = this[g], d.style && (e = d.style.display, 
            !f._data(d, "olddisplay") && "none" === e && (e = d.style.display = ""), "" === e && "none" === f.css(d, "display") && f._data(d, "olddisplay", cr(d.nodeName)));
            for (g = 0; h > g; g++) {
                d = this[g];
                if (d.style) {
                    e = d.style.display;
        ...
        hide: function(a, b, c) {
            if (a || 0 === a) return this.animate(cq("hide", 3), a, b, c);
        ...
        animate: function(a, b, c, d) {
            ...
            return this[e.queue === !1 ? "each" : "queue"](function() {
                ...
                for (i in a) {
                    ...
                    "inline" === f.css(this, "display") && "none" === f.css(this, "float") && (f.support.inlineBlockNeedsLayout ? (j = cr(this.nodeName), 
                ...
                for (i in a) k = new f.fx(this, b, i), h = a[i], cj.test(h) ? k["toggle" === h ? d ? "show" : "hide" : h]() : (l = ck.exec(h), 
                m = k.cur(), l ? (n = parseFloat(l[2]), o = l[3] || (f.cssNumber[i] ? "" : "px"), 
                "px" !== o && (f.style(this, i, (n || 1) + o), m = (n || 1) / k.cur() * m, f.style(this, i, m + o)), 
                l[1] && (n = ("-=" === l[1] ? -1 : 1) * n + m), k.custom(m, n, o)) : k.custom(m, h, ""));
                return !0;
            });
        },
        stop: function(a, b) {
        ...
        custom: function(a, b, c) {
            ...
            var d = this, e = f.fx;
            this.startTime = cn || co(), this.start = a, this.end = b, this.unit = c || this.unit || (f.cssNumber[this.prop] ? "" : "px"), 
            this.now = this.start, this.pos = this.state = 0, g.elem = this.elem, g() && f.timers.push(g) && !cl && (cl = setInterval(e.tick, e.interval));
        },
        show: function() {
        ...
        hide: function() {
            this.options.orig[this.prop] = f.style(this.elem, this.prop), this.options.hide = !0, 
            this.custom(this.cur(), 0);
        },
        step: function(a) {
            var g, h, b = cn || co(), c = !0, d = this.elem, e = this.options;
            if (a || b >= e.duration + this.startTime) {
                this.now = this.end, this.pos = this.state = 1, this.update(), e.animatedProperties[this.prop] = !0;
                for (g in e.animatedProperties) e.animatedProperties[g] !== !0 && (c = !1);
                if (c) {
                    null != e.overflow && !f.support.shrinkWrapBlocks && f.each([ "", "X", "Y" ], function(a, b) {
            ...
            1/0 == e.duration ? this.now = b : (h = b - this.startTime, this.state = h / e.duration, 
        ...
        tick: function() {
            for (var a = f.timers, b = 0; a.length > b; ++b) a[b]() || a.splice(b--, 1);
            a.length || f.fx.stop();
        },
        interval: 13,
        stop: function() {
    ...
    f.fn.offset = "getBoundingClientRect" in c.documentElement ? function(a) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
            if (f.offset.supportsFixedPosition && "fixed" === k.position) break;
            c = j ? j.getComputedStyle(b, null) : b.currentStyle, l -= b.scrollTop, m -= b.scrollLeft, 
            b === d && (l += b.offsetTop, m += b.offsetLeft, f.offset.doesNotAddBorder && (!f.offset.doesAddBorderForTableAndCells || !cs.test(b.nodeName)) && (l += parseFloat(c.borderTopWidth) || 0, 
            m += parseFloat(c.borderLeftWidth) || 0), e = d, d = b.offsetParent), f.offset.subtractsBorderForOverflowNotVisible && "visible" !== c.overflow && (l += parseFloat(c.borderTopWidth) || 0, 
        ...
        initialize: function() {
            ...
            f.extend(b.style, {
                ...
                height: "1px",
                visibility: "hidden"
            }), b.innerHTML = j, a.insertBefore(b, a.firstChild), d = b.firstChild, e = d.firstChild, 
            h = d.nextSibling.firstChild.firstChild, this.doesNotAddBorder = 5 !== e.offsetTop, 
            this.doesAddBorderForTableAndCells = 5 === h.offsetTop, e.style.position = "fixed", 
            e.style.top = "20px", this.supportsFixedPosition = 20 === e.offsetTop || 15 === e.offsetTop, 
            e.style.position = e.style.top = "", d.style.overflow = "hidden", d.style.position = "relative", 
            this.subtractsBorderForOverflowNotVisible = -5 === e.offsetTop, this.doesNotIncludeMarginInBodyOffset = a.offsetTop !== i, 
            a.removeChild(b), f.offset.initialize = f.noop;
        },
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (a && !ct.test(a.nodeName) && "static" === f.css(a, "position")) a = a.offsetParent;
                return a;
            });
        }
